...
const About = () => {
    return (
        <div className='max-w-6xl mx-auto my-16 mb-56'> <h3 className="text-5xl font-medium text-[#311E25] mb-8 text-center">
        About Me
    </h3>
    ...
    <div className="flex justify-between gap-20 items-center">
                ...
                <p className="text-lg text-justify w-7/12">
            ...
            <div className="w-7/12 relative">
                ...
                <img src={uits} alt=""  className='  h-72 w-[400px]'/>
                <img src={pic1} alt="" className='absolute -right-10 top-[70%] h-72 w-[400px]' />
            </div>
        </div></div>
