                    ...
                    <li className="flex timeline-box w-[400px] md:w-[520px]  items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div className="timeline-end   justify-between space-y-5">
                                ...
                                <p className="text-2xl font-medium text-[#311E25]"> B.Sc. in Computer Science and Engineering</p>
                    ...
                    <li className="flex timeline-box w-[400px] md:w-[520px]  items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div className="timeline-end   justify-between space-y-5">
                                ...
                                <p className="text-2xl font-medium text-[#311E25]"> Higher Secondary School Certificate</p>
                            ...
                            <div className="timeline-end   justify-between space-y-5">
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-row justify-between gap-5 md:gap-36 text-lg mr-5 ml-2">
                                        ...
                                        <p className="text-lg "> <div className="flex items-center gap-2"><FaAward /> GPA : 5.00/5.00</div></p>
                                    </div>

                                </div>
                                <p className="text-2xl font-medium text-[#311E25]"> Secondary School Certificate</p>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="timeline-end   justify-between space-y-5">
                                <div className="flex items-center">
                                    ...
                                    <div className="text-lg mr-5 ml-2">August, 2023 - Current</div>
                                </div>
                                <p className="text-2xl font-medium text-[#311E25]"> Lecturer</p>
                                <p className="text-lg"> <div className="flex items-center gap-2"><FaUniversity /> Bangladesh University of Business and Technology</div></p>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="timeline-end   justify-between space-y-5">
                                <div className="flex items-center">
                                    ...
                                    <div className="text-lg mr-5 ml-2">January, 2023 - August, 2023</div>
                                </div>
                                <p className="text-2xl font-medium text-[#311E25]"> Teaching Assistant</p>
                                <p className="text-lg"> <div className="flex items-center gap-2"><FaUniversity /> Bangladesh University of Business and Technology</div></p>
...
<div className="flex items-center">
    ...
    <div className="timeline-end   justify-between space-y-5">
        <div className="flex items-center">
            ...
            <div className="text-lg mr-5  ml-2">March, 2023 - Current</div>
        </div>
        <p className="text-2xl font-medium text-[#311E25]"> Research Assistant</p>
        <p className="text-lg"> <div className="flex items-center gap-2"><FaUniversity /> Amir Lab</div></p>
